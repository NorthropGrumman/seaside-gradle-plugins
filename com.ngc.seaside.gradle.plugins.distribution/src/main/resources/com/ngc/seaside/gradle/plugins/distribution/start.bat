...
set FRAMEWORK_OPTS=-DNG_FW_HOME="%NG_FW_HOME%" -Djavax.xml.accessExternalSchema=all -Dfelix.config.properties="file:%NG_FW_HOME%/platform/configuration/config.properties" __FELIX_JVM_PROPERTIES__
