...
class SeasideCppCoveragePluginIT {
    ...
    private static File pathToTheDestinationProjectDirectory() {
        return turnListIntoPath("build", "integrationTest", "cpp", "coverage", "sealion-java-hello-world")
    }
    ...
    private static File sourceDirectoryWithTheTestProject() {
        return turnListIntoPath("src", "integrationTest", "resources", "sealion-java-hello-world")
    }
